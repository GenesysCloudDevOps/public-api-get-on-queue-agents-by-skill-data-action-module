A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get On Queue Agents by Skill
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-on-queue-agents-by-skill-data-action-module.git?ref=v1.0.0"
    action_name        = "Get On Queue Agents by Skill"
